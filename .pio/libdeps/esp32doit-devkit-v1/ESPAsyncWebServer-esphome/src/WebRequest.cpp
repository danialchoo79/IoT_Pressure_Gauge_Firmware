...
const char * AsyncWebServerRequest::methodToString() const {
  if(_method == WRM_ANY) return "ANY";
  else if(_method & WRM_GET) return "GET";
  else if(_method & WRM_POST) return "POST";
  else if(_method & WRM_DELETE) return "DELETE";
  else if(_method & WRM_PUT) return "PUT";
  else if(_method & WRM_PATCH) return "PATCH";
  else if(_method & WRM_HEAD) return "HEAD";
  else if(_method & WRM_OPTIONS) return "OPTIONS";
  return "UNKNOWN";
}
